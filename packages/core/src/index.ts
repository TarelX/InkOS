...
// Rich attachments（V1 patch-rich-attachments 移植）：宿主文档抽取 + 能力路由原生文件输入
export {
  extractDocument,
  decodeTextSmart,
